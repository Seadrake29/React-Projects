...
const InfoCard = ({ icon, title, subtitle, link }) => {
  return (
    <div className="bg-white rounded-2xl group lg:py-8 w-full lg:h-[206px] shadow-md lg:shadow-none hover:scale-125 hover:bg-lime ease-in-out duration-300 transition cursor-pointer">
