...
const Perks = () => {
  return (
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center px-4 gap-8 md:gap-[300px]">
        <div className="flex flex-col items-center">
          <img
            src="/images/home/FCA-Banner-ezgif.com-gif-to-webp-converter.webp"
            alt="Hero 1"
            className="w-[372px] h-[378px] object-cover mb-6 md:mb-0"
          />
        </div>

        <div className="flex flex-col space-y-6 font-raleway">
          {[
