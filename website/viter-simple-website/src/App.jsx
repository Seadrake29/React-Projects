...
import FeatureCards from "./components/cards/feature.jsx"; // Make sure path is correct
      ...
      <div className="h-full  ">
        ...
        <div className="m-5 p-10">
          ...
          <p className="font-normal my-5">
            This is a simple one-page website built with React and Tailwind CSS.
          </p>
        </div>
        <div className="m-5 p-10">
        ...
        <div className="footer pt-[220px]">
          <div className="bg-blue-950 p-10 text-center text-white text-lg">
